Official URL of this project: <https://codeberg.org/hiiamboris/red-dataset> (you may be viewing an automatic mirror otherwise)
...
3. Run `sudo ~/dataset/setup.sh` script to set up necessary software
