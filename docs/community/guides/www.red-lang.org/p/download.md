...
For ArchLinux (Manjaro included), there is a Red package [here](https://aur.archlinux.org/packages/red/). Or you can run above Linux binary after installing 32-bit support with:
...
- [Chocolatey](https://chocolatey.org/packages/red): `choco install red (not functional, waiting to be updated)`

Direct links to latest builds

- Windows: [raw binary](https://static.red-lang.org/dl/win/red-view.exe?reload=true)
- Linux: [raw binary](https://static.red-lang.org/dl/linux/red-view?reload=true)
- macOS: [raw binary](https://static.red-lang.org/dl/mac/red-view?reload=true)

[![](https://resources.blogblog.com/img/icon18_edit_allbkg.gif)](https://www.blogger.com/page-edit.g?blogID=5936111837781935054&pageID=5410793160254419334&from=pencil "Edit Page")
