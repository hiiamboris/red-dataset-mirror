Original URL: <https://learnxinyminutes.com/red/index.html>
...
To learn more about Rebol and Red join the [chat on Gitter](https://gitter.im/red/red). And if that is not working for you drop a mail to us on the \[Red mailing list](mailto: [\[email protected\]](https://learnxinyminutes.com/cdn-cgi/l/email-protection#7f0d1a1b52131e11183130202c2f3e323f18101018131a180d100a0f0c511c1012)) (remove NO\_SPAM).
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/red.md) yourself!

Originally contributed by Arnold van Hofwegen, and updated by [12 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/red.md).
