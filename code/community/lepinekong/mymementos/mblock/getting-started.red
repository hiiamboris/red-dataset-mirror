Red [
    Title: "Getting Started with mblock"
]
...
Memento: [
    ...
    Step-1: [
        ...
        .text: {Once mBlock is launched:}
        .image: https://i.imgur.com/EyRrb6O.png
        .text: {Click on Tab}
        .quote: {Sprites}
        .image: https://i.imgur.com/JgcoAsD.png
        .text: {From Tab}
        .quote: {Events}
        .image: https://i.imgur.com/oAvopVO.png
        .text: {Drag and drop}
        .quote: {When clicked}
        .image: https://i.imgur.com/mj5QPXn.png
        .text: {From tab}
        .quote: {Motion}
        .text: {drag and drop}
        .quote: {Move 10 steps}        
        .image: https://i.imgur.com/vdqHTaA.png     
        .text: {Run by clicking on the icon}
        .quote: {Flag}
    ...
    Step-7: [
        ...
        .text: {To solve the issue, use:}
        .quote: {Set Rotation Style}
        .image: https://i.imgur.com/M2g6cLg.png
        .text: {For Left Arrow Key you must set back:}
        .quote: {Move -10}
        .text: {to}
        .quote: {Move 10}
