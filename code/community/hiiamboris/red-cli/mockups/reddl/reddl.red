...
reddl: function [
	...
	/gui           guiname       "Download GUI console and make a shorthand copy (e.g. redgui)"
	/cli           cliname       "Download CLI console and make a shorthand copy (e.g. red)"
	/comp          compname      "Download compiler and make a shorthand copy (e.g. redc)"
	...
	/binary-path   bpath [file!] "Specify directory where to save the copies"
	/p "alias /platform"
	...
	unless pname [
		pname: form system/platform
		print `"No platform specified, defaulting to (pname)"`
	]
	...
	foreach [type flag name] links [
		...
		unless parse page [thru "Automated builds" thru flag thru {<a href="} copy link to {">} to end] [
