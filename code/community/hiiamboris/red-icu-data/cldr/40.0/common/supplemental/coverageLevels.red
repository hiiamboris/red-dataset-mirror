    ...
    supplementalData [
        ...
        coverageLevels [
            approvalRequirements [
                ...
                approvalRequirement [#votes "20" #locales {ar ca cs da de el es fi fr he hi hr hu it ja ko nl no pl pt pt_PT ro ru sk sl sr sv th tr uk vi zh zh_Hant} #paths {//ldml/dates/calendars/calendar\[@type=.gregorian.\]/(days|months).*}] 
                approvalRequirement [#votes "20" #locales {ar ca cs da de el es fi fr he hi hr hu it ja ko nl no  pl pt pt_PT ro ru sk sl sr sv th tr uk vi zh zh_Hant} #paths {//ldml/dates/calendars/calendar\[@type=.gregorian.\]/(date|time)Formats/.*}] 
            ...
            coverageVariable [#key "%language80" #value {(sc|doi|a([fkmrz]|gq|s[at]?)|b([gm-os]|as|e[mz]?|rx?)|c([aosy]|cp|eb?|gg|hr|kb)|d([ez]|av?|je|sb|ua|yo)|e([elnos-u]|bu|wo)|f([afory]|il?|ur)|fa_AF|g([adlv]|sw|uz?)|h([eirtuy]|aw?|mn|sb)|i[adgist]|j([av]|go|mc)|k([imnuwy]|a[bm]?|de|ea|gp|hq|kj?|ln?|ok?|s[bfh]?)|l([bgnotv]|ag?|kt|rc|u[oy]?)|m([iklr-ty]|a[is]|er|fe|g[ho]?|ni?|u[al]|zn)|n([belo]|aq|ds?|mg|nh?|us|yn?)|o[mrs]|p([alst]|cm)|qu|r([mnu]|of?|wk?|hg)|s([dgiklnoqrt-w]|a[hqt]?|bp|e[hs]?|hi|mn?)|t([ag-ikort]|eo?|wq|zm)|u([gkrz]|nd)|v([i]|ai|un)|w(ae|o)|x(h|og)|y([io]|av|ue|rl)|z([hu]|gh|xx))}] 
            coverageVariable [#key "%languagecomp" #value "(gan|hak|hsn|nan|wuu)"] 
