    ...
    supplementalData [
        ...
        plurals [
            #type "ordinal" 
            pluralRules [
                #locales {af am an ar bg bs ce cs da de dsb el es et eu fa fi fy gl gsw he hr hsb ia id in is iw ja km kn ko ky lt lv ml mn my nb nl no pa pl prg ps pt root ru sd sh si sk sl sr sw ta te th tpi tr ur uz yue zh zu} 
            ...
            pluralRules [
                #locales "lij" 
                pluralRule [#count "many" ! {n = 11,8,80..89,800..899 @integer 8, 11, 80~89, 800~803}] 
                pluralRule [#count "other" ! {@integer 0~7, 9, 10, 12~17, 100, 1000, 10000, 100000, 1000000, …}]
            ] 
            pluralRules [
                #locales "ka" 
