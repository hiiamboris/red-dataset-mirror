...
Red regressed so much while I wasn't looking that Spaces won't run anymore 😃
...
[17:00:51](#30G9xzM0Um401x227ChpKUpzCD0c0YWzxa-FUUVpX0w) <rebolek (Boleslav Březovský)>:
Of course, they are different from each other.

[17:01:12](#FAe3hdW5hg1Ge6hDV08CACtzilc405o6HXYMxzLBEnI) <rebolek (Boleslav Březovský)>:
...
[17:57:55](#yCQf8CvPQVyeavHV04vHjmKD2ggrqgMm12vABN7NMyM) <rebolek (Boleslav Březovský)>:
What is the advantage of map! here?

[17:58:20](#faTzcWbfzeB6TxeFXy2nPuHtfN73bxvM74z4gQmiraA) <rebolek (Boleslav Březovský)>:
...
[18:00:43](#VnGTOjoJ5Hpl2eoWahEDDatZNLDGLbPFELxcGTwkVIQ) <rebolek (Boleslav Březovský)>:
...
[18:05:21](#UeMzeLH__GOwytmZuOwnBrSkXAWsbA90DPBj1b0ULu8) <rebolek (Boleslav Březovský)>:
```
db: [
    [name age]
    [morlok 3'000]
...
[18:08:49](#NqrtnRVV0ca-1FFQDmpZDAqDlKaY6tmRBm5zcfCY8kk) <rebolek (Boleslav Březovský)>:
So it would be ordered not by rows but by columns, I see.

[18:09:05](#Ou7FuxnwuREZO6fkSV2dONYfQdQwJkYK45ey0w4uMKk) <rebolek (Boleslav Březovský)>:
...
[18:30:29](#45VdUKePrSMLVMk3f_donxImPlJtv2Zx0FYEi46TX7c) <rebolek (Boleslav Březovský)>:
...
[18:32:15](#tQZy73nXiARopUm3_QKe8G3ENhXR2VykX_1dmNBfIQA) <rebolek (Boleslav Březovský)>:
What's the point of 
```
customers: [
  1 [morlok 3'000]
...
[18:33:30](#agRjnBKWWxjiqWfS2sHK6vKUT6k6Irj8jWLb4EkLRK0) <rebolek (Boleslav Březovský)>:
...
[18:36:59](#26Uj9QueGq1k5inP6ae2TkA3xstZ7xy9of3RSC3Hf9s) <rebolek (Boleslav Březovský)>:
...
About ☝ [21 novembre 2021 19:27](https://gitter.im/red/red/code?at=619a8f87cdb5c1081a23deb7)
...
[18:39:42](#_wWHmTdNgPgN2bJtuzu12DPFW2fR41KezBeT5km3wFA) <rebolek (Boleslav Březovský)>:
I don'ŧ understand, it sounds to complicated to me. I probably would need to see your data.
...
[18:48:08](#EOVtOO86HyRkzcOVOtt9X7wx7Dz753w3N8v9LrzqBzU) <rebolek (Boleslav Březovský)>:
Simply:
```
; define data
...
[18:48:24](#yYB3sZAeB9oWNS_gbkFpPgxzYxfpTmuiKzV9zhPh0Hw) <rebolek (Boleslav Březovský)>:
* Simply:
```
; define data
>> customers: [[morlok 3'000 alabama] [ujo 35 texas]]
...
[18:51:52](#pZ6J7zchpTujJv7JVVRCwHbx_X78kKxe92dVR-AbUgc) <rebolek (Boleslav Březovský)>:
...
[18:52:45](#F2OsNJIrWAJYfTIxH2cbELGj0tZBtmka_sVeeOvXF-M) <rebolek (Boleslav Březovský)>:
```
...
[18:58:30](#HNeuGVw9FWeUqsnfWfojF9MgR1dBxwAvUSdeCBwwEfw) <rebolek (Boleslav Březovský)>:
...
[19:03:34](#jS4wLUQ3RCNBZPkCuPYcqDV29REDDTyyEsBdy2swLJQ) <rebolek (Boleslav Březovský)>:
Wow, how much memory does it take.

[19:03:59](#OI1DrugZux2nv6fmfXWbY9c3pF6-2-gk1ZI70SarP8I) <rebolek (Boleslav Březovský)>:
...
[19:12:01](#pHRxarFR5pQmFxfl7xDxjCZs5ydgnEUVCLPpf5QIR0I) <rebolek (Boleslav Březovský)>:
...
[19:16:29](#etjjL62Y6_5wFPkGvScFDJCkZ-xyKIxMUmOsRGipm2k) <rebolek (Boleslav Březovský)>:
...
[19:20:54](#HOnx8m1b9GpGpV5vjAW3vGNMbiDM7t6Ugr1NoqdYFD8) <rebolek (Boleslav Březovský)>:
Nice!
...
[5:50:40](#W5JveKWFzPsKUWFdZ-GPQdE61sZZO8YYC9ogyTXmDKE) <rebolek (Boleslav Březovský)>:
...
[9:18:56](#XnWbuFbQRZVKhps7ZctQnylu1prjFuUDF9evJiev0HE) <rebolek (Boleslav Březovský)>:
...
[9:20:04](#DMLYvB_ybZNTkNTMSiF73-MlAzAFbTQ2AdMxYYqiEgE) <rebolek (Boleslav Březovský)>:
